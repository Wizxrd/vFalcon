...
namespace vFalcon.Nasr
{
    public class NavData
    {
        ...
        private static readonly string root = Loader.GetAppDirectory();
        ...
        private static readonly string appDirectory = Loader.GetAppDirectory();
        ...
        public async Task DownloadParserData()
        {
            try
            {
                ...
                Directory.Delete($"{Loader.GetAppDirectory()}\\Nasr", recursive: true);
            }
            catch (Exception ex)
            {
